...
/**
 *A class responsible to build a panel that displays information about product;
 * @author Dumitru Muntean
 *
 */
public class OrderPanelsGenerator {
	 ...
	 */
	public OrderPanelsGenerator(Product product)
	{
	...
	/**
	 * Init buttons with a button listener;
